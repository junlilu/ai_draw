...
parser.add_argument('--taming', dest='taming', action='store_true', default=True)

parser.add_argument('--hug', dest='hug', action='store_true', default=True)
...
train_group.add_argument('--epochs', default = 20*10, type = int, help = 'Number of epochs')

train_group.add_argument('--save_every_n_steps', default = 1000*10, type = int, help = 'Save a checkpoint every n steps')
...
train_group.add_argument('--batch_size', default = 4*4, type = int, help = 'Batch size')
...
train_group.add_argument('--learning_rate', default = 1e-6, type = float, help = 'Learning rate')

train_group.add_argument('--clip_grad_norm', default = 0.5, type = float, help = 'Clip gradient norm')

train_group.add_argument('--lr_decay', dest = 'lr_decay', action = 'store_true', default=True)
...
model_group.add_argument('--depth', default = 2*4, type = int, help = 'Model depth')
